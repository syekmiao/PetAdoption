    ...
    <div class="container-xxl py-5">
        ...
        <?php 
            ...
            if(isset($_POST["search"])){
                ...
                $rows = mysqli_query($conn, "SELECT * FROM pets WHERE petName = '$seachInput' OR petType = '$seachInput' OR petBreed = '$seachInput'
                    OR petSize = '$seachInput' OR petColor = '$seachInput' OR petInformation = '$seachInput'
                    ORDER BY petCreateDate DESC");
